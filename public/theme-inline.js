...
(function(){
  try {
    ...
    var logoL = "https://whitelabel.progem.com.br/arquivos/128/logo.png?v=7";
    var logoD = "https://whitelabel.progem.com.br/arquivos/128/logo-dark.png?v=7";
    if (style) {
    ...
    var seoMetaTitle = "São Bento";
    var seoDesc = "Assistência familiar, assistência pet, telemedicina 24h, memorial online e clube de benefícios para quem quer cuidado e tranquilidade no dia a dia.";
    var seoOgImage = "https://whitelabel.progem.com.br/arquivos/128/icons/og-image.png?v=7";
    var seoOgUrl = "https://demo.progem.com.br/";
    ...
    var fav = "https://whitelabel.progem.com.br/arquivos/128/icons/favicon.png?v=7";
    if (fav) upsertLink("icon", "tenant-favicon", fav);
    var fsvg = "https://whitelabel.progem.com.br/arquivos/128/icons/favicon.svg?v=7";
    if (fsvg) upsertLink("icon", "tenant-favicon-svg", fsvg, "image/svg+xml");
    var ap = "https://whitelabel.progem.com.br/arquivos/128/icons/apple-touch-icon.png?v=7";
