/* Gerado de D:\whitelabel-clean\config\tenants\cuidarmais.json */
window.__TENANT__ = {"slug":"cuidarmais","v":2,"assetsBaseUrl":"https://whitelabel.progem.com.br/arquivos/320/","vars":{"--primary":"#0F4C81","--primary-dark":"#0B3A63","--primary-light":"#1C6AA6","--secondary":"#D4A51A","--on-primary":"#FFFFFF","--surface":"#FFFFFF","--surface-alt":"#F4F6F9","--text":"#0F172A","--text-muted":"#6B7280","--c-border":"rgba(15,23,42,0.10)","--nav-hover-bg":"color-mix(in srgb, var(--primary) 12%, transparent)","--nav-active-bg":"color-mix(in srgb, var(--primary) 22%, transparent)","--nav-active-color":"#0F4C81","--highlight":"#D4A51A","--button-hover":"color-mix(in srgb, var(--primary) 25%, #000000)"},"varsDark":{"--surface":"#0B1220","--surface-alt":"#111C33","--text":"#F8FAFC","--text-muted":"#CBD5E1","--c-border":"rgba(255,255,255,0.15)","--primary":"#1C6AA6","--primary-dark":"#0F4C81","--primary-light":"#3C89C7","--secondary":"#E0B836","--nav-hover-bg":"color-mix(in srgb, var(--primary) 18%, transparent)","--nav-active-bg":"color-mix(in srgb, var(--primary) 30%, transparent)","--nav-active-color":"#FFFFFF","--highlight":"#E0B836","--button-hover":"color-mix(in srgb, var(--primary) 35%, #000000)"},"logo":"cuidarmais.png","heroTitle":"Assistência planejada para cuidar de quem você ama","heroSubtitle":"Soluções completas em assistência com atendimento humanizado e benefícios pensados para o seu bem-estar.","heroSlides":[{"id":"planos","tag":"Planos em destaque","title":"Proteção e tranquilidade para sua família","subtitle":"Coberturas pensadas para proteger sua família com orientação e atendimento humanizado.","image":"planos.png","primary":{"label":"Ver planos","to":"/planos","variant":"primary"},"secondary":{"label":"Área do associado","to":"/login","variant":"outline"},"showValuePills":true,"valuePills":[{"icon":"ShieldCheck","label":"Proteção completa"},{"icon":"Users","label":"Para a família"},{"icon":"Clock","label":"Atendimento 24h"}]},{"id":"beneficios","tag":"Clube de vantagens","title":"Economia real para usar todo mês","subtitle":"Vantagens e parcerias em serviços e comércios conveniados — benefícios que fazem diferença no orçamento.","image":"descontos.png","primary":{"label":"Ver benefícios","to":"/beneficios","variant":"primary"},"secondary":{"label":"Parceiros","to":"/beneficios","variant":"outline"},"showValuePills":true,"valuePills":[{"icon":"Percent","label":"Descontos reais"},{"icon":"Store","label":"Rede conveniada"},{"icon":"Wallet","label":"Economia mensal"}]},{"id":"memorial","tag":"Memorial Digital","title":"Memorial e homenagens em um só lugar","subtitle":"Um espaço digital para mensagens, homenagens e detalhes de cerimônias com respeito e simplicidade.","image":"memorial.png","primary":{"label":"Acessar memorial","to":"/memorial","variant":"primary"},"secondary":null,"showValuePills":true,"valuePills":[{"icon":"BookHeart","label":"Homenagens"},{"icon":"MessageCircle","label":"Mensagens"},{"icon":"Globe","label":"Acesso online"}]}],"domain":"cuidarmaisobidos.com"};
...
(function(){
  try {
    ...
    if (docEl){
      docEl.setAttribute('data-tenant', t.slug || 'cuidarmais');
