...
export function CadastroStepper({ steps, currentStep, currentIndex, onStep, disabled }) {
        ...
        return (
          <span key={step.id} className="contents">
            ...
            <button
              ...
              disabled={locked}
              className="h-10 w-10 md:h-11 md:w-11 rounded-full border inline-flex items-center justify-center font-semibold transition-transform focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--primary)] focus-visible:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
              style={{
...
export default function CadastroStepShell({ title, subtitle, plain, children }) {
  return (
    <div
      className="rounded-2xl md:rounded-3xl border shadow-sm"
      style={{
        background: "var(--surface)",
        borderColor: "var(--c-border)",
      }}
