// src/components/DateSelectBR.jsx
import { useEffect, useMemo, useRef, useState } from "react";
import { AlertTriangle } from "lucide-react";

/**
 * Componente de seleção de data (DD/MM/AAAA) com restrição por idade mínima/máxima.
 * Props:
 *  - valueISO: string "YYYY-MM-DD"
 *  - onChangeISO: (iso:string)=>void
 *  - invalid: boolean (exibe estado de erro)
 *  - className: string
 *  - minAge: number | undefined (em anos)
 *  - maxAge: number | undefined (em anos)
 *  - idPrefix: string | undefined (prefixo para ids dos selects)
 */
export default function DateSelectBR({
  valueISO,
  onChangeISO,
  invalid = false,
  className = "",
    ...
    <div>
      ...
      {(invalid || softWarn) && (
        ...
        >
          ...
          {invalid ? "Idade fora do limite." : softWarn}
        </p>
      )}
    </div>
  );
