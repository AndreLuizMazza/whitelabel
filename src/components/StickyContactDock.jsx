...
/**
 * CTA fixo: WhatsApp + Ligação
 * - Mobile: barra inferior “dock” colada no bottom
 * - Desktop: NÃO EXIBE (somente mobile)
...
export default function StickyContactDock({
  ...
  phoneNumber,
  message,
  position = "bottom-right", // mantido por compatibilidade, mas não usado (somente mobile)
  showLabels = true,
  className = "",
  ...
  // extraAction: { label, href?, onClick?, ariaLabel?, badge? } // mantido por compatibilidade, mas não usado (desktop removido)
  extraAction,
  reserveSpace = true,
  compactNearFooter = true, // mantido por compatibilidade, mas não usado (desktop removido)
  hideOnKeyboard = true,
